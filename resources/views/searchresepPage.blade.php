...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            @if (!empty($data['resep']))
                @foreach ($data['resep'] as $row)
                    <div class="col-md-6 col-lg-3 mb-4">
                        <a href="{{ 'resep/' . $row->id }}" class="text-decoration-none text-dark">
                            <div class="card">
                                <img alt="{{ $row->description }}" class="card-img-top" height="200"
                                    src="{{ asset('uploads/recipe/gambar/' . $row->gambar) }}" width="300" />
                                <div class="card-body">
